...
cp "$SCRIPT_DIR/plugin/src/main/resources/plugin.yml" "$SCRIPT_DIR/plugin/src/main/resources/plugin.yml.compilebackup"
...
# Restore plugin.yml
mv -f "$SCRIPT_DIR/plugin/src/main/resources/plugin.yml.compilebackup" "$SCRIPT_DIR/plugin/src/main/resources/plugin.yml"
